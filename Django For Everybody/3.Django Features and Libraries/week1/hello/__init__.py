...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>__init__.py : /home/akanchhachoudhary/django_projects/mysite/hello/__init__.py : Editor : akanchhachoudhary : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="__init__.py : /home/akanchhachoudhary/django_projects/mysite/hello/__init__.py : Editor : akanchhachoudhary : PythonAnywhere">
        ...
        <link rel="stylesheet" href="/static/CACHE/css/output.93590726e867.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/static/CACHE/css/output.c184c0fc7128.css" type="text/css" /><link rel="stylesheet" href="/static/CACHE/css/output.28401090a3ea.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "B4s5qdotS7iRpbuvOdLiw59DNlGVSvJICcqNeRe4k5hk3OiVAPQZvGo8Z1EooSSs";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/output.fd03122ca7ee.js"></script>
        

        <script type="text/javascript" src="/static/CACHE/js/output.df0a2ce83d48.js"></script>
        
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          file: "/user/akanchhachoudhary/files/home/akanchhachoudhary/django_projects/mysite/hello/__init__.py",
          check_hash: "/user/akanchhachoudhary/files/home/akanchhachoudhary/django_projects/mysite/hello/__init__.py",
        ...
        var filename = "/home/akanchhachoudhary/django_projects/mysite/hello/__init__.py";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            csrfToken: "B4s5qdotS7iRpbuvOdLiw59DNlGVSvJICcqNeRe4k5hk3OiVAPQZvGo8Z1EooSSs",
            path: "/home/akanchhachoudhary/django_projects/mysite/hello/__init__.py"
          }
        );
  ...
  <div id="id_editor_toolbar">
    ...
    <div class="pull-left">
      <span id="id_breadcrumbs_div"><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/">/</a><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/home">home</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/home/akanchhachoudhary">akanchhachoudhary</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/home/akanchhachoudhary/django_projects">django_projects</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/home/akanchhachoudhary/django_projects/mysite">mysite</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/akanchhachoudhary/files/home/akanchhachoudhary/django_projects/mysite/hello">hello</a><span class="breadcrumb_entry">/</span><wbr><span class="breadcrumb_entry breadcrumb_terminal">__init__.py</span></span>
      ...
      <div id="id_editor_buttons_right" class="form-inline">
        ...
        <button id="id_display_sharing_options" class="btn btn-default" data-toggle="modal" data-target="#id_file_sharing_modal" title="Get a URL to share this file">
          ...
          <button class="btn btn-info run_button" title="Save &amp; Run (Ctrl + R)">
            ...
            <form class="reload_web_app" style="display: flex" method="POST" action="/user/akanchhachoudhary/webapps/akanchhachoudhary.pythonanywhere.com/reload">
              <button class="btn btn-default" type="submit" title="Reload akanchhachoudhary.pythonanywhere.com">
  ...
  <li class=""><a id="id_dashboard_link" href="/user/akanchhachoudhary/">Dashboard</a></li>
  <li class=""><a id="id_consoles_link" href="/user/akanchhachoudhary/consoles/">Consoles</a></li>
  <li class=""><a id="id_files_link" href="/user/akanchhachoudhary/files/home/akanchhachoudhary">Files</a></li>
  <li class=""><a id="id_web_app_link" href="/user/akanchhachoudhary/webapps/">Web</a></li>
  <li class=""><a id="id_tasks_link" href="/user/akanchhachoudhary/tasks_tab/">Tasks</a></li>
  <li class=""><a id="id_databases_link" href="/user/akanchhachoudhary/databases/">Databases</a></li>
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <li class="">
    <form action="/logout/" method="POST">
      <input type='hidden' name='csrfmiddlewaretoken' value='B4s5qdotS7iRpbuvOdLiw59DNlGVSvJICcqNeRe4k5hk3OiVAPQZvGo8Z1EooSSs' />
  ...
  <div>
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 well">
            ...
            2 consoles.  You can
            have more if you
            <a href="/user/akanchhachoudhary/account/">upgrade your account</a>!

            <p>
            Alternatively, if you don't feel like paying us more money, you
            can <a href="/user/akanchhachoudhary/consoles/">kill some consoles on your Consoles page</a>.
        </div>
    </div>
</div>
